  ...
  return (
    <div className="about-us-container">
      ...
      <div className="bottom-div">
        ...
        <p>
          Welcome to Neighbor Nest, your go-to online marketplace where creativity
          ...
          services and personalized gifts, Neighbor Nest is a celebration of human
          ingenuity and passion.
          <br />
          <br />
          At Neighbor Nest, we believe in building more than just a marketplace; we're
          ...
          small business, Neighbor Nest is your springboard to connect, discover, and
          ...
          Explore Neighbor Nest today and uncover the endless possibilities that
          await.
        </p>
      </div>
    </div>
